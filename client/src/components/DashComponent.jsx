        ...
        const fetchUsers=async () => {
            try {
                ...
                if(res.ok){
                    ...
                    setLastMonthUsers(data.lastMonthsRegisteredUsers)
                }
            } catch (error) {
                console.log(error);
            }
            ...
            <div className="flex flex-wrap gap-4 justify-center">
                <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiOutlineUserGroup className="bg-teal-700 text-white rounded-full text-5xl p-2 shadow-lg"/>
                ...
                <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiAnnotation className="bg-purple-700 text-white rounded-full text-5xl p-2 shadow-lg"/>
                ...
                <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiDocumentText className="bg-lime-700 text-white rounded-full text-5xl p-2 shadow-lg"/>
                    ...
                    <Table hoverable>
                        ...
                        posts.map((post)=>(
                            <Table.Body key={post._id} className='divide-y'>
                                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-700">
                                    <Table.Cell>
                                        <img src={post.image} alt='post' className="w-14 h-10 rounded-md bg-gray-500"></img>
                                    </Table.Cell>
                                    <Table.Cell className="w-96">
                                        {post.title}
                                    </Table.Cell>
